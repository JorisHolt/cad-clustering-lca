---
title: "Cluster Derivation in SWEDEHEART"
output:
  html_document:
    toc: true
    toc_depth: 2
...
This figure shows the Spearman rank correlation between all variables used in the LCA model. As most variables are ordinal or binary, Spearman’s rho is preferred over Pearson’s correlation.

![Correlation plot for LCA variables](correlation.nolvef.jpg)
...
```
## Model Selection: Elbow Plot

The plot below shows the Bayesian Information Criterion (BIC) for models with 2 to 10 clusters. The "elbow" marks the point of diminishing returns in model fit and was used to guide the selection of four clusters.

![Elbow plot for number of clusters](Elbowplot.png)
